  ...
  grunt.initConfig({
    ...
    concat: {
      dist_full: {
        ...
        dest: 'js/jmychampolion-withlibs.js'
      },
      dist_nolibs: {
        src: [
          'src/js/*.js'
        ],
        dest: 'js/jmychampolion.js'
      },
      dist_css: {
        src: [
          'tmp/css/*.css'
        ],
        dest: 'css/jmychampolion.css'
      }
    },
    uglify: {
      build_full: {
        src: 'js/jmychampolion-withlibs.js',
        dest: 'js/jmychampolion-withlibs.min.js'
      },
      build_nolibs: {
        src: 'js/jmychampolion.js',
        dest: 'js/jmychampolion.min.js'
      }
    },
    watch: {
      less: {
